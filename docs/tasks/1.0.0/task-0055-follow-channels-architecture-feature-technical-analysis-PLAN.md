...
2. **Check for New Videos**
   ...
   - Manual trigger via UI context menu ("Check for new videos")
...
| [backend/app/domain/services/channel_discovery_service.py](../../backend/app/domain/services/channel_discovery_service.py)             | Discovery service interface                |
...
| [backend/app/infrastructure/services/channel_discovery_service_impl.py](../../backend/app/infrastructure/services/channel_discovery_service_impl.py)                 | Discovery service using yt-dlp  |
...
| [backend/app/infrastructure/tasks/channel_check_tasks.py](../../backend/app/infrastructure/tasks/channel_check_tasks.py)                                             | Check for new videos task       |
