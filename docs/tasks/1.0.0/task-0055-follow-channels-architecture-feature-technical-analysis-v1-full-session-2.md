...
⏺ Perfect! I've successfully gathered the project context. Here's a summary of what I've learned about LabCastARR:

Project Overview

LabCastARR is a full-stack web application that creates podcast channels for your Homelab by converting YouTube videos or uploaded audio files into
podcast episodes with iTunes/Spotify-compatible RSS feeds.
...
- FastAPI + Python 3.12+
- SQLite with SQLAlchemy (async via aiosqlite)
...
- Backend: fastapi, sqlalchemy, celery, yt-dlp, podgen, aiofiles, python-jose
- Frontend: next, @tanstack/react-query, shadcn components, react-hook-form, zod

Key Features

1. YouTube to Podcast: Convert YouTube videos to podcast episodes
2. Audio File Upload: Support MP3, M4A, WAV, OGG, FLAC (with auto-conversion)
3. Follow YouTube Channels: Monitor channels for new videos and create episodes
...
The codebase follows a clean monorepo structure:

- /backend - FastAPI backend with Clean Architecture
- /frontend - Next.js frontend
- /docs - Documentation (tasks, sessions, specs, references)
- /scripts - Utility scripts
- Docker Compose for development and production

Current State

You're on the features/follow-channels branch with significant work on:

- Follow channel feature (task-0047 series)
- Notifications system
- Celery task status tracking
- UI improvements (sidepanel, subscriptions tabs)

The project is well-documented with comprehensive CLAUDE.md instructions and detailed task documentation.
